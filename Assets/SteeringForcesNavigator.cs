...
namespace Assets
{
    public class SteeringForcesNavigator
    {
        ...
        public Vector3 ComputeDisplacement( Agent shopper)
        {
        ...
        private Vector3 separation_forces(Agent agent)
        {
        ...
        private static Vector3 ObstacleAvoidance( Agent agent, Vector3 normalized_direction)
        {Collider[] hitColliders;
        ...
        private Vector3 SeekBehaviour(Agent agent)
        {
